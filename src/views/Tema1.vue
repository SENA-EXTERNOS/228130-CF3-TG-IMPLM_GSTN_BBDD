    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-9.col-sm-10(data-aos="fade-left")
        ...
        .bloque-texto-b.color-secundario.p-4
          .bloque-texto-b__texto
            i.fas.fa-quote-left
            p Se encarga de establecer quién puede conectar al servidor y de asegurar que cada usuario legalmente conectado ejecute solamente las operaciones que tenga permitidas.
            br
          ...
          table
            ...
            tbody
              ...
              tr
                ...
                td Medio
              tr
                td(rowspan=26) Columnas privilegios
                td Select_priv
                td Select_priv
                td Select_priv
              tr
